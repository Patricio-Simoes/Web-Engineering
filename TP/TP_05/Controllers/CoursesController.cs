...
namespace TP_05.Controllers
{
    ...
    {
        private readonly TP_05Context _context;

        public CoursesController(TP_05Context context)
        {
            _context = context;
        }
        ...
        {
            var tP_05Context = _context.Course.Include(c => c.Category);
            return View(await tP_05Context.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TP_05Context.Course'  is null.");
            }
            var course = await _context.Course.FindAsync(id);
            if (course != null)
            {
